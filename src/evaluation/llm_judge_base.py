"""
LLM Judge Base Module

This module provides core functionality for evaluating model responses using local LLM models
via Ollama. It implements a comprehensive evaluation framework for assessing therapeutic
effectiveness and psychological content quality.

Key Features:
- Local model evaluation (cost-effective, private)
...
- Mood Health: Emotional positivity and mental health indicators
- Relevance: Appropriateness and on-topic nature
- Emotional Competence: Emotional intelligence and awareness
- Thought Adaptiveness: Cognitive flexibility and adaptive thinking
...
MODEL_NAME = "hf.co/mradermacher/Emollama-7b-GGUF:Q8_0"  # Local evaluation model
