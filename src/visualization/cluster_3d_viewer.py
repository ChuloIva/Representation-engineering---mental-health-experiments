...
Interactive 3D visualization tool for exploring clustering results using UMAP dimensionality
reduction and multiple clustering algorithms. Creates an interactive "galaxy" visualization
that opens automatically in the browser.

Key Features:
- UMAP dimensionality reduction to 3D space
- Multiple clustering algorithms (K-means, Hierarchical, DBSCAN)
- Quality metrics computation (silhouette score, etc.)
